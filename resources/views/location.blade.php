...
<div class="container-fluid">
  ...
  <h5 class="main-title-w3layouts mb-2">Locations</h5>
            ...
            @if (!empty($location))
              ...
              <tr>
                ...
                <td>
                  ...
                  <form id="delete-form-{{ $row->id }}" action="{{ route('location.destroy', $row->id) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
	        ...
	        <div class="modal-body">
	          	<form action="" method="" id="addForm">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <textarea class="form-control" rows="3" id="description" name="description" placeholder="Location Description"></textarea>
                    </div>
		            </div>
